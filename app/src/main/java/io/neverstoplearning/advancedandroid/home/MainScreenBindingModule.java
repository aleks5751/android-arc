...
import io.neverstoplearning.advancedandroid.contributordetails.ContributorDetailsComponent;
...
@Module(subcomponents = {
        ...
        ContributorDetailsComponent.class,
})
public abstract class MainScreenBindingModule {
    ...
    @Binds
    @IntoMap
    @ControllerKey(ContributorDetailsController.class)
    abstract AndroidInjector.Factory<? extends Controller> bindContributorDetailsInjector(ContributorDetailsComponent.Builder builder);
}
